...
```{admonition} What is competitive programming?
:class: dropdown
...
```{admonition} Types of (competitive) programmers:
:class: dropdown
...
```{admonition} How does competitive programming help with interviews?
:class: dropdown
...
## 2. First set of tips to be competitive

```{admonition} Type faster!!!
:class: dropdown
...
```{admonition} Quickly identify problem-type
:class: dropdown

- This is important in ICPC competition: divide work among team members. 
- Helps with recalling DS/AL. 

```{admonition} Understand how to do algorithm analysis (CSC 241)
...
```{admonition} Master programming languages 
:class: dropdown
...
```{admonition} Master the art of testing codes
:class: dropdown
...
```{admonition} Online judges and platforms
:class: dropdown
...
```{admonition} Anatomy of a programming contest problem
:class: dropdown
...
## 4. Typical input/output routines
...
```{admonition} Your first problem: Moscow Dream
:class: dropdown
...
```{admonition} UVa problem 10071: Back to High School Physics
:class: dropdown
...
```{admonition} UVa problem 11614: Etruscan Warriors Never Play Chess
:class: dropdown
...
```{admonition} UVa problem 12250: Language Detection
:class: dropdown
...
```{admonition} UVa problem 11764: Jumping Mario
:class: dropdown
...
```{admonition} UVa problem 10424: Love Calculator
:class: dropdown
...
```{admonition} UVa problem 12643 (Medium): Tennis Rounds
:class: dropdown
...
## 5. Basic String Processing Tasks
